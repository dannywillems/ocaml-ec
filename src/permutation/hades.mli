(** HADES Strategy, based on {{: https://eprint.iacr.org/2019/1107.pdf  }
    On a Generalization of Substitution-Permutation Networks: The HADES Design
    Strategy}
*)
...
module Make (Param : PARAMETERS) (Scalar : Ff_sig.PRIME) : sig
