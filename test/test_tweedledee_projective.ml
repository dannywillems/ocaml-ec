module TweedledeeValueGeneration =
  Mec.Curve.PBT.MakeValueGeneration (Mec.Curve.Tweedledee.Projective)
module TweedledeeEquality =
  Mec.Curve.PBT.MakeEquality (Mec.Curve.Tweedledee.Projective)
module TweedledeeECProperties =
  Mec.Curve.PBT.MakeECProperties (Mec.Curve.Tweedledee.Projective)
